...
>
### [我的博客在这里 &rarr;](http://qinganw.github.io)
...
```
# Site settings
title: QA Blog                    # 你的博客网站标题
SEOTitle: 清安的博客 | QA Blog		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: qinganw     # 你的github账号
jianshu_username: 02a970017ae9  # 你的简书ID。
...
date:       2018-06-13
author:     QA
header-img: img/post-bg-flex-layout.jpg
catalog: 	 true
tags:
    - Flex
---
...
sidebar-avatar: /img/avatar-qa.jpg     #你的大头贴，请使用绝对地址.注意：名字区分大小写！后缀名也是
```
...
在下面输入的社交账号，没有的添加的不会显示在侧边框中。新加入了[简书](https:/www.jianshu.com)链接, <https://www.jianshu.com/u/02a970017ae9>
...
# Google Analytics
ga_track_id: 'UA-120986696-1'            # 你用Google账号去注册一个就会给你一个这样的id
ga_domain: wangqingan.me			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“QA Blog”** 但是我想要在搜索的时候显示 **“清安的博客 | QA Blog”** ，这个就需要 SEO Title 来定义了。
